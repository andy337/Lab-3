...
namespace Лаб_3
{
    ...
    {       // поля
        ...
        public void Set(int index_1, int index_2, double element)
        {
            ...
            // конструктори
        public MyMatrix(double[,] array) // constructor
        {
            matrix = array;
        }

        public MyMatrix(MyMatrix previousMatrix) // copy constructor
        {
            matrix = previousMatrix.matrix;
        }

        public MyMatrix(double[][] array) // constructor for zyb array
        {
